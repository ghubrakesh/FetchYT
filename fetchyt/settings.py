"""
Django settings for fetchyt project.
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'youtube_api',  # Your app
    'django_celery_results',  # Celery result backend
    'django_celery_beat',     # Celery beat for periodic tasks
]

# For Rest API Pagination
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'youtube_api.pagination.VideoPagination',
    'PAGE_SIZE': 10
}
...
WSGI_APPLICATION = 'fetchyt.wsgi.application'
